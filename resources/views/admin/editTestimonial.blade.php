...
@section('title', 'Rent Car Admin | Edit Testimonial')
@section('content')
<!-- page content -->
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form method="POST" action="{{route('updateTestimonial', $testimonial->id)}}" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            @csrf
                            @method('put')
