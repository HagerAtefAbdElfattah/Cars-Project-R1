      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mr-auto">
            <h2>Hager Atef Abd EL-Fattah</h2>
            <p>Hi there! I'm Hager Atef, a passionate Laravel and PHP/MySQL developer with a focus on laravel 10. I'm adept at crafting elegant, robust web applications that deliver value to users and businesses.</p>
            <h4> Skills:</h4>
                    <p>Laravel framework expertise (larvel 10)
                    PHP and MySQL proficiency</p>                 
          </div>
        </div>
      </div>
    </div>
