    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 blog-content">
          <img src="{{asset('assets/images/'.$car->image)}}" alt="{{$car->title}}" class="img-fluid p-3 mb-5 bg-white rounded">
          ...
          <p class="lead">{{Str::of($car->content)->limit(50)}}</p>
          <p class="text-center">{{$car->content}}</p>


          <div class="pt-5">
            <p>Category:  <a href="" class="active">{{$car->category->categoryName}}</a></p>
          </div>
          ...
          <div class="sidebar-box">
            <div class="categories">
              ...
              @foreach ( $categories as  $category)
                   <li><a href="#">{{$category->categoryName}} <span>{{App\Models\Car::where('category_id', $category->id)->where('active',1)->count()}}</span></a></li>
              @endforeach
            </div>
          </div>
          <div class="sidebar-box">
